...
final class WOOF {
    ...
    public function print_plugin_options() {
        ...
        var woof_show_notes = <?php echo $this->show_notes ? 1 : 0 ?>;
        <?php
        $stxt = ob_get_clean();
...
//
    ...
    public function wp_load_js() {
        ...
        var woof_select_type = '<?php echo $this->get_select_type(); ?>';
    ...
    public function wp_footer() {
        ...
        if (isset($this->settings['autoform_toggle_closed_image']) AND!empty($this->settings['autoform_toggle_closed_image'])) {
            ...
            <style>
                .woof_show_auto_form,
                .woof_hide_auto_form{
                    background: url("<?php echo $this->settings['autoform_toggle_closed_image'] ?>") !important;
                }
            </style>
            <?php
        }
    ...
    public function woof_products($atts, $is_prediction = false) {
        ...
        public function woof_draw_products() {
            if (isset($_REQUEST['link'])) {
                ...
                $_GET = apply_filters('woof_draw_products_get_args', $_GET, $_REQUEST['link']);
            }
            $product_ids = "";
        ...
        public function woof_redraw_woof() {
            ...
            $_REQUEST['woof_shortcode_txt'] = $shortcode;
